...
$saldo = $tampil['saldo'];
 ...
 if ($service == "100") {
  $harga = $jumlah * 29;
  $barang = "Facebook Like Post/Foto S1";
 } else if ($service == "16") {
  $harga = $jumlah * 25;
...
<b>Jumlah:</b> <?php echo $jumlah?> Like<br />
<b>Tanggal Pembelian:</b> <br><?php echo $date?> <br />

                               <?php
    $api_key = "SVZC0652Q7O1"; // 15 Random Kode Api Key Smart Voc anda
    $method = "order"; // Method jangan di ubah
    $layanan = "3"; // Kode layanan bisa dilihat di Tabel Layanan
...
<? } else if ($order->result == "success") { ?>
    Order Success : No. Order <?php echo $order->no_order; ?>
<? } ?>
</li>
<? }
}
