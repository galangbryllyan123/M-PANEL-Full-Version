...
<b>Jumlah:</b> <?php echo $jumlah?> Retweets<br />
<b>Tanggal Pembelian:</b> <br><?php echo $date?> <br />
                               <?php
    $api_key = "CMBCOWN2Z7FZGVO"; // 15 Random Kode Api Key CM Panel anda
    $method = "order"; // Method jangan di ubah
    $layanan = "108"; // Kode layanan bisa dilihat di Tabel Layanan
...
if ($order->result == "error") { ?>
    <b>Order Error :</b> <?php echo $order->alasan; ?>
