...
$tampil = mysql_fetch_array($query); ?>
				<div class="panel-heading">
					<span class="panel-title">Facebok Post Like</span>
				</div>
				<div style="text-align:left;"><div class="panel-body">
  <div class="alert alert-info alert-block fade in"> <h4> <i class="icon-info-sign"></i> <font color='red'><b>INFO :</b></font></h4><b><p> - Pastikan Status/Foto bersifat public.<br /> - Masukkan status/foto dengan benar. <br>- Untuk yang melanggar peraturan, Jika terjadi error dan saldonya berkurang, bukan tanggung jawab kami</b><p><p><i>Terjadi Masalah? Hubungi Admin.</i><p><i>Terimakasih.</i></div>
 ...
 <label for="normal-field" class="control-label">Url/Link</label>
                                                    ...
                                                    <div class="col-md-9">
 <div class="form-group"> <input type="text" placeholder="Link Status/Foto" class="form-control" id="username" name="username"> </div>
 </div> </div> 
                                            <div class="control-group">
                                               <div class="col-md-3"> 
 ...
 <option value="100">Facebook Status/Foto Like S1</option> 
 </select>
 </div>
 </div>
 </div> 
