...
<br />
                                        <div class="form-group">
<button class="btn btn-primary" id="btnLogin" onclick="tambahuser();" ><i class="zmdi zmdi-mail-send" name="proces" type="submit"></i> Submit</button> 
                                        </div>

<div class="alert alert-info">
Member : Rp 15.000,- <br /> MemberVIP : Rp 30.000,- <br /> Reseller : Rp 50.000,- <br />
</div>
                                </div>
